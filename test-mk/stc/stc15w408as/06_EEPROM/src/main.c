...
/* --- Веб: www.STCMCU.com ------------------------- ------------------- */
/* --- Веб: www.GXWMCU.com ----------------- --------------------------- */
/* Если вы хотите использовать этот код в своей программе, укажите в программе,
 * что используется STC. Материалы и процедуры */
/* Если вы хотите применить этот код в статье, укажите в статье информацию и
 * процедуры, используя STC */
/* ------------------------------------------- -------------------------- */

// Этот пример скомпилирован в среде разработки Keil, пожалуйста, выберите
// модель чипа Intel 8058. Если нет особых пояснений, рабочая частота
// Обычно 11.0592 МГц
...
main ()
{
  ...
  for (i = 0; i < 512;
       i++) //Определить, если стирание прошло успешно (полное определение FF)
    {
...
----------------------------*/
void
IapProgramByte (WORD addr, BYTE dat)
{
  IAP_CONTR = ENABLE_IAP; //Включить IAP
