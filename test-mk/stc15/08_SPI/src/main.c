...
sbit SPISS      =   P1^1;       //SPI  Порт выбора ведомого SPI, подключиться к порту SS другого MCU 
...
void InitUart()
{
...
#if URMD == 0
    T2L = 0xd8;                 //Установить значение перезагрузки скорости передачи данных 
    ...
    TL1 = 0xd8;                 //Установка значения перезагрузки скорости передачи 
...
#ifdef MASTER
    SPCTL = SPEN | MSTR;        //Режим хоста # 
#else
    SPCTL = SPEN;               // Режим ведомого устройства # 
#endif
}
