...
void i2c_acquire (i2c_t dev){
  /*в оригинале, это старт и стоп тактового генератора для аппаратного I2C,
     типа экономия потребления... */
};

void i2c_release (i2c_t dev){};

int
i2c_read_reg (i2c_t dev, uint16_t addr, uint16_t reg, void *data,
              uint8_t flags)
{
  if (dev->hw_wire)
...
int
i2c_read_regs (i2c_t dev, uint16_t addr, uint16_t reg, void *data, size_t len,
               uint8_t flags)
{
...
int
i2c_read_byte (i2c_t dev, uint16_t addr, void *data, uint8_t flags)
{
  if (dev->hw_wire)
...
int
i2c_read_bytes (i2c_t dev, uint16_t addr, void *data, size_t len,
                uint8_t flags)
{
  if (dev->hw_wire)
...
int
i2c_write_byte (i2c_t dev, uint16_t addr, uint8_t data, uint8_t flags)
{
  if (dev->hw_wire)
...
int
i2c_write_bytes (i2c_t dev, uint16_t addr, const void *data, size_t len,
                 uint8_t flags)
{
  if (dev->hw_wire)
...
int
i2c_write_reg (i2c_t dev, uint16_t addr, uint16_t reg, uint8_t data,
               uint8_t flags)
{
  if (dev->hw_wire)
...
int
i2c_write_regs (i2c_t dev, uint16_t addr, uint16_t reg, const void *data,
