case ILI9341_S4P:
  ...
  UTFT_LCD_Write_DATA2(0x79); //79 78
  ...
  UTFT_LCD_Write_DATA2(0x26); //26 25
  ...
  UTFT_LCD_Write_DATA2(0xBE); //BE 94
  UTFT_LCD_Write_COM(0xB1); //frame control
  UTFT_LCD_Write_DATA2(0x00);
  UTFT_LCD_Write_DATA2(0x1B); //1B 70
  ...
  UTFT_LCD_Write_DATA2(0x55); //16bit
  UTFT_LCD_Write_COM(0x36); //mem access
  UTFT_LCD_Write_DATA2((1<<3)|(1<<6));
  //UTFT_LCD_Write_DATA2((1<<3)|(1<<7)); //rotate 180
