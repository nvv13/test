case R61581:
		...
		UTFT_LCD_Write_DATA2(0x00);//0X10

// 		UTFT_LCD_Write_COM(0xB9); //PWM Settings for Brightness Control
// 		UTFT_LCD_Write_DATA2(0x01);// Disabled by default. 
// 		UTFT_LCD_Write_DATA2(0xFF); //0xFF = Max brightness
...
// 		UTFT_LCD_Write_DATA2(0x18);
		...
		UTFT_LCD_Write_DATA2(0x0A);//0X12
		UTFT_LCD_Write_DATA2(0x6B);//0x7D
		UTFT_LCD_Write_DATA2(0x04);
		UTFT_LCD_Write_DATA2(0x06);//0x08
		UTFT_LCD_Write_DATA2(0x15);//0x0A
		UTFT_LCD_Write_DATA2(0x10);
		UTFT_LCD_Write_DATA2(0x00);
		UTFT_LCD_Write_DATA2(0x60);//0x23
		...
		UTFT_LCD_Write_DATA2(0x07);//VCI1
		UTFT_LCD_Write_DATA2(0x14);//VRH 0x1D
		UTFT_LCD_Write_DATA2(0xA2);//BT 0x06

		UTFT_LCD_Write_COM(0xD1);
		UTFT_LCD_Write_DATA2(0x03);
		UTFT_LCD_Write_DATA2(0x5A);//VCM  0x5A
		UTFT_LCD_Write_DATA2(0x10);//VDV

		UTFT_LCD_Write_COM(0xD2);
		UTFT_LCD_Write_DATA2(0x03);
		UTFT_LCD_Write_DATA2(0x04);//0x24
		UTFT_LCD_Write_DATA2(0x04);
		...
		UTFT_LCD_Write_DATA2(0x00);
		UTFT_LCD_Write_DATA2(0x01);
		UTFT_LCD_Write_DATA2(0xDF);//320

		UTFT_LCD_Write_COM(0x2B);
		UTFT_LCD_Write_DATA2(0x00);
		UTFT_LCD_Write_DATA2(0x00);
		UTFT_LCD_Write_DATA2(0x01);
		UTFT_LCD_Write_DATA2(0x3F);//480
