...
board HLK-W801-KIT-V1.1 + wifi + 5643AS-1 + button + weather
...
также, надо сделать файлик - или не обязательно, в исходниках main.c выбор
w_wifi_pass.h 
~~~
#ifndef W_WIFI_PASS_H
#define W_WIFI_PASS_H

#define MY_WIFI_AP	"Ваша точка доступа"
#define MY_WIFI_PASS    "пароль на точку доступа"
#endif /* W_WIFI_PASS_H */
~~~
в той же директории где лежит директория test, т.е. файлик в сами проекты исходники не входит
