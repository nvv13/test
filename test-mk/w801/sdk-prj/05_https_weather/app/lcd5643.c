...
{
if(i_pos>OUT_DIG_4 && i_off==1)return; //
/*
...
switch(i_pos)
{
 ...
 {
  if(iMode==MODE_CLOCK)  //case OUT_DIG_1: //digit 1, 0=12 1=9,8,6 - i_num=11.7.4.2.1.10.5
   {
        reg_temp=reg_temp 
         | (1 << 16)    //9
         | (1 << 17)    //8
 ...
 {
  if(iMode==MODE_CLOCK)  //case OUT_DIG_4: //digit 4, 0=6 1=12,9,8 - i_num=11.7.4.2.1.10.5
   {
        reg_temp=reg_temp 
         | (1 << 15)    //12
         | (1 << 16)    //9
