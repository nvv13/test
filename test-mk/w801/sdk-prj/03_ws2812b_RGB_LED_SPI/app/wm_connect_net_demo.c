  ...
  if (strncmp ((char *)sock_rx, "time", 4) == 0)
    {
      ...
      tls_get_rtc (&tblock);
      i_len_ret
          = sprintf (sock_rx, "date %d.%02d.%02d %02d:%02d:%02d\n",
...
int
demo_connect_net (char *ssid, char *pwd)
{
