...
extern "C"
{
  ...
  void
  base64_init_encodestate_nonewlines (base64_encodestate *state_in)
  {
  ...
  char
  base64_encode_value (const char n)
  {
    char r;
  ...
  int
  base64_encode_chars (const char *plaintext_in, int length_in, char *code_out)
  {
