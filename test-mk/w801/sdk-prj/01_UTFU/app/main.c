...
{
  printf ("user_app1_task start TFT01_47V89 172x320 HW SPI st7789v3\n");

  // подключаем библиотеку UTFT

  // TFT01_47V89 - для ST7789v
  UTFT_UTFT (TFT01_47V89, (u8)NO_GPIO_PIN // WM_IO_PB_17  //RS  SDA
             ,
  ...
  while (1)
    {                 //
      ...
      UTFT_drawRoundRect (
          10, 10, 310,
          162); // Рисуем прямоугольник со скруглёнными углами (с
      ...
      UTFT_fillCircle (160, 86, 50); // Рисуем закрашенную окружность (с
