...
// -----------------
// Так как большинство людей имеют только один или возможно два разных модуля
// дисплея, то можно сэкономить несколько Кбайт памяти отключив поддержку
// ненужных контроллеров. Для этого и предназначен данный файл библиотеки UTFT.
// Строки, в которых указаны используемые Вами контроллеры должны быть
// ЗАКОММЕНТИРОВАНЫ, а "ненужные" строки, наоборот РАЗКОММЕНТИРОВАНЫ
...
#define DISABLE_ILI9325D                                                      \
  1 // ITDB24D / ITDB24DWOT / ITDB28 / TFT01_24_8 / TFT01_24_16 / DMTFT24104 /

// DMTFT28103	- This single define will disable both 8bit and 16bit
    // mode for this controller
...
//	#define DISABLE_ILI9341_S5P		1	// TFT01_22SP /
    // TFT01_24SP / TFT22SHLD / DMTFT28105
...
#define DISABLE_S6D1121                                                       \
  1 // ITDB24E	- This single define will disable both 8bit and 16bit mode for
    // this controller
#define DISABLE_SSD1289                                                       \
  1 // ITDB32S / TFT01_32 / ELEE32_REVA / ELEE32_REVB / CTE32	- This single
    // define will disable both 8bit, 16bit and latched mode for this
    // controller
