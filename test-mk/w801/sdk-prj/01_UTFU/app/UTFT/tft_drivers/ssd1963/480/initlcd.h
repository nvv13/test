case SSD1963_480:
	...
	UTFT_LCD_Write_DATA2(0x01);		//Set HDP	479
	UTFT_LCD_Write_DATA2(0xDF);
	UTFT_LCD_Write_DATA2(0x01);		//Set VDP	271
	UTFT_LCD_Write_DATA2(0x0F);
	UTFT_LCD_Write_DATA2(0x00);

	UTFT_LCD_Write_COM(0xB4);		//HSYNC
	UTFT_LCD_Write_DATA2(0x02);		//Set HT	531
	UTFT_LCD_Write_DATA2(0x13);
	UTFT_LCD_Write_DATA2(0x00);		//Set HPS	8
	UTFT_LCD_Write_DATA2(0x08);
	UTFT_LCD_Write_DATA2(0x2B);		//Set HPW	43
	UTFT_LCD_Write_DATA2(0x00);		//Set LPS	2
	UTFT_LCD_Write_DATA2(0x02);
	UTFT_LCD_Write_DATA2(0x00);

	UTFT_LCD_Write_COM(0xB6);		//VSYNC
	UTFT_LCD_Write_DATA2(0x01);		//Set VT	288
	UTFT_LCD_Write_DATA2(0x20);
	UTFT_LCD_Write_DATA2(0x00);		//Set VPS	4
	UTFT_LCD_Write_DATA2(0x04);
	UTFT_LCD_Write_DATA2(0x0c);		//Set VPW	12
	UTFT_LCD_Write_DATA2(0x00);		//Set FPS	2
	UTFT_LCD_Write_DATA2(0x02);

	UTFT_LCD_Write_COM(0xBA);
	UTFT_LCD_Write_DATA2(0x0F);		//GPIO[3:0] out 1
