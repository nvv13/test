...
case TFT00_96SP_2:
 // Смещение матрицы относительно строк/столбцов контроллера
#define TFT096_2_COL_SHIFT_PIXEL 24
#define TFT096_2_ROW_SHIFT_PIXEL 0
#define ST77XX_CASET 0x2A
	UTFT_LCD_Write_COM(ST77XX_CASET); //Set Column Address
  	UTFT_LCD_Write_DATA2((x1 + TFT096_2_COL_SHIFT_PIXEL)>>8);
  	UTFT_LCD_Write_DATA2((x1 + TFT096_2_COL_SHIFT_PIXEL) & 0xFF);
  	UTFT_LCD_Write_DATA2((x2 + TFT096_2_COL_SHIFT_PIXEL)>>8);
  	UTFT_LCD_Write_DATA2((x2 + TFT096_2_COL_SHIFT_PIXEL) & 0xFF);
#define ST77XX_RASET 0x2B
	UTFT_LCD_Write_COM(ST77XX_RASET);  //Set Page Address
  	UTFT_LCD_Write_DATA2((y1 + TFT096_2_ROW_SHIFT_PIXEL)>>8);
  	UTFT_LCD_Write_DATA2((y1 + TFT096_2_ROW_SHIFT_PIXEL) & 0xFF);
  	UTFT_LCD_Write_DATA2((y2 + TFT096_2_ROW_SHIFT_PIXEL)>>8);
  	UTFT_LCD_Write_DATA2((y2 + TFT096_2_ROW_SHIFT_PIXEL) & 0xFF);
#define ST77XX_RAMWR 0x2C
	UTFT_LCD_Write_COM(ST77XX_RAMWR); 
	break;
