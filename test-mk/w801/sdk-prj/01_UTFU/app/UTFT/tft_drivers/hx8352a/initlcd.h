case HX8352A:
	...
	UTFT_LCD_Write_DATA2(0x02);  //TESTM=1 
             
	UTFT_LCD_Write_COM(0x85);  
	UTFT_LCD_Write_DATA2(0x03);  //VDC_SEL=011
	UTFT_LCD_Write_COM(0x8B);  
	UTFT_LCD_Write_DATA2(0x01);
	UTFT_LCD_Write_COM(0x8C);  
	UTFT_LCD_Write_DATA2(0x93); //STBA[7]=1,STBA[5:4]=01,STBA[1:0]=11
        
	UTFT_LCD_Write_COM(0x91);  
	UTFT_LCD_Write_DATA2(0x01); //DCDC_SYNC=1
        
	UTFT_LCD_Write_COM(0x83);  
	UTFT_LCD_Write_DATA2(0x00); //TESTM=0
	//Gamma Setting
	...
	UTFT_LCD_Write_DATA2(0x91);
       
	UTFT_LCD_Write_COM(0x2B);  
	UTFT_LCD_Write_DATA2(0xF9);
	delay(10);
