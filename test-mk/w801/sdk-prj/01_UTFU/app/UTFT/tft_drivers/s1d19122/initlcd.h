case S1D19122:
	...
	UTFT_LCD_Write_DATA2(0x11);
	UTFT_LCD_Write_DATA2(0x22);
	UTFT_LCD_Write_DATA2(0x99);
	UTFT_LCD_Write_DATA2(0xAA);
	UTFT_LCD_Write_DATA2(0xAA);
	UTFT_LCD_Write_DATA2(0xAA);
	UTFT_LCD_Write_DATA2(0xBB);
	UTFT_LCD_Write_DATA2(0xBB);
	UTFT_LCD_Write_DATA2(0xAA);
	...
	for(i=0;i<32;i++)
	{ 
		UTFT_LCD_Write_DATA2(R);
		R=R+2;
	}
	for(i=0;i<64;i++)
	{ 
		UTFT_LCD_Write_DATA2(G);
		G=G+1;
	} 
	for(i=0;i<32;i++)
	{ 
		UTFT_LCD_Write_DATA2(B);
		B=B+2;
	}    
	break;
