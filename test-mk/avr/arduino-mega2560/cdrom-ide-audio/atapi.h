...
#define MAX_TOC_LENGTH 50
  ...
  {
  public:
    // This isn't directly mapped to anything in the spec, but is related to
    // "Table 59 - CD-ROM Media Type Codes" (p123)
    enum MediaStatus
    {
      ...
      DOOR_CLOSED_UNKNOWN_DISC  // CD-ROM drive isn't reporting the media type,
                                // so it might be audio
    };
    ...
    // See "Table 115 - CD-ROM Current Position Data Format (Format Code 01h)",
    // p176
