...
char* a_con[]={"con","192.168.1.47","1883","cl1"};

char* a_sum_temp2[]={"sub","/temp2"};


char* a_temp2[]={"pub","/temp2",NULL};
char* a_pressure2[]={"pub","/pressure2",NULL};
char* a_humidity2[]={"pub","/humidity2",NULL};
